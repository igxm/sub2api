...
curl -sSL https://raw.githubusercontent.com/igxm/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
- Uses `SUB2API_IMAGE=ghcr.io/igxm/sub2api:latest` by default
...
1. Download the latest release from [GitHub Releases](https://github.com/igxm/sub2api/releases)
