...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldVideoPricePerSecond, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldVideoPricePerSecond:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field video_price_per_second", values[i])
			} else if value.Valid {
				_m.VideoPricePerSecond = new(float64)
				*_m.VideoPricePerSecond = value.Float64
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	if v := _m.VideoPricePerSecond; v != nil {
		builder.WriteString("video_price_per_second=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
